...
A token is used to hold data

2. What steps can you take in your web apps to keep your data secure?

Well for one, you could use JSON web tokens for authorization headers, as this will help secure your app from unwanted outside sources.

3. Describe how web servers work.

They store, process and deliver web pages to clients.
